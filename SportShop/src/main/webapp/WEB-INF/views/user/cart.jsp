							...
							<div class="table-row">
								<div class="photo">
									<a href='<c:url value="/category/product"></c:url>'> <img
										src='<c:url value="/assets/user/images/products/product-1.jpg"></c:url>'
										alt="">
									</a>
								</div>
								<div class="name">
									<a href='<c:url value="/category/product"></c:url>'>${item.getProductDetail().getProduct().getName()}
										Boyfriend Short</a>
								...
								<div class="qty qty-changer">
									<fieldset>
										...
										<input type="text" class="qty-input"
											value="${item.getQuantity() }" data-min="0" data-max="10">
						...
						<div class="col-sm-6 col-md-4">
							...
							<form class="white" action="#">
								<label>Enter your coupon code if you have one.</label> <input
									type="text" class="form-control dashed">
								<div>
			...
			<div class="block empty-cart">
				<div class="container">
					<div class="image-empty-cart">
						<img
							src='<c:url value="/assets/user/images/empty-basket.png"></c:url>'
							alt="">
