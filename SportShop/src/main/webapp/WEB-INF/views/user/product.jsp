					...
					<div class="container">
						...
						<div class="product-slider-wrapper">
							<div class="product-creative-slider">
								<div class="item"> <img src='<c:url value = "/assets/user/images/products/product-creative-2.jpg"></c:url>' class="inner-zoom" data-zoom-image='<c:url value = "/assets/user/images/products/large/product-creative-2.jpg"></c:url>' alt=""> </div>
								<div class="item"> <img src='<c:url value = "/assets/user/images/products/product-creative-1.jpg"></c:url>' class="inner-zoom" data-zoom-image='<c:url value = "/assets/user/images/products/large/product-creative-1.jpg"></c:url>' alt=""> </div>
								<div class="item"> <img src='<c:url value = "/assets/user/images/products/product-creative-3.jpg"></c:url>' class="inner-zoom" data-zoom-image='<c:url value = "/assets/user/images/products/large/product-creative-3.jpg"></c:url>' alt=""> </div>
							</div>
							...
							<div class="col-lg-8 col-lg-push-2">
								<div class="product-info-block creative">
									...
									<div class="product-description">
										<p>Quisque sollicitudin nulla felis, vel sollicitudin felis mollis in. Cras mauris ligula, pharetra a consectetur a, interdum sit amet. Nunc dui nulla, efficitur a tempor non, euismod id libero.</p>
									</div>
									<!-- remove class more-options if less than three -->
									<div class="product-options more-options">
										<div class="product-size swatches"> <span class="option-label">Size:</span>
									...
									<div class="product-actions">
										...
										<div class="actions">
											<div class="price"> <span class="old-price"><span>$140.00</span></span> <span class="special-price"><span>$114.00</span></span>
											</div>
											<button data-loading-text='<i class="icon icon-spinner spin"></i><span>Add to cart</span>' class="btn btn-loading"><i class="icon icon-cart"></i><span>Add to cart</span></button> <a href="#" class="btn product-details"><i class="icon icon-external-link"></i></a> </div>
									</div>
								</div>
							</div>
						</div>
												...
												<div class="product-item-info">
													...
													<div class="product-item-photo">
														...
														<div class="product-item-gallery-main">
															<a href="#"><img class="product-image-photo" src='<c:url value = "/assets/user/images/products/product-11-1.jpg"></c:url>' alt=""></a>
														...
														<div class="product-item-actions">
															<div class="share-button toBottom"> <span class="toggle"></span>
														...
														<div class="product-item-gallery-previews-wrapper">
															<div class="product-item-gallery-previews">
																<div class="item">
																	<a href="#"><img src='<c:url value = "/assets/user/images/products/product-11.jpg"></c:url>' alt=""></a>
																</div>
																<div class="item">
																	<a href="#"><img src='<c:url value = "/assets/user/images/products/product-11-1.jpg"></c:url>' alt=""></a>
																</div>
																<div class="item">
																	<a href="#"><img src='<c:url value = "/assets/user/images/products/product-11-2.jpg"></c:url>' alt=""></a>
																</div>
															</div>
															<div class="carousel-arrows"></div>
														</div>
											...
											<div class="product-item-inside">
												<div class="product-item-info">
													...
													<div class="product-item-photo">
														<!-- product main photo -->
														<div class="product-item-gallery-main">
															<a href="#"><img class="product-image-photo" src='<c:url value = "/assets/user/images/products/product-19.jpg"></c:url>' alt=""></a>
															<a href="quick-view.html" title="Quick View" class="quick-view-link quick-view-btn"> <i class="icon icon-eye"></i><span>Quick View</span></a>
														</div>
														<!-- /product main photo  -->
														<!-- Product Label -->
														...
														<div class="product-item-gallery-previews-wrapper">
															<div class="product-item-gallery-previews">
																<div class="item">
																	<a href="#"><img src='<c:url value = "/assets/user/images/products/product-19.jpg"></c:url>' alt=""></a>
																</div>
																<div class="item">
																	<a href="#"><img src='<c:url value = "/assets/user/images/products/product-19-1.jpg"></c:url>' alt=""></a>
																</div>
																<div class="item">
																	<a href="#"><img src='<c:url value = "/assets/user/images/products/product-19-2.jpg"></c:url>' alt=""></a>
																</div>
																<div class="item">
																	<a href="#"><img src='<c:url value = "/assets/user/images/products/product-19-3.jpg"></c:url>' alt=""></a>
																</div>
															</div>
															<div class="carousel-arrows"></div>
														</div>
														...
														<ul class="color-swatch hidden-xs">
															<li class="active">
																<a data-image='<c:url value = "/assets/user/images/products/product-19.jpg"></c:url>' href="#"><img src='<c:url value = "/assets/user/images/colorswatch/color-yellow.png"></c:url>' alt="Yellow"></a>
															</li>
															<li>
																<a data-image='<c:url value = "/assets/user/images/products/product-19-c1.jpg"></c:url>' href="#"><img src='<c:url value = "/assets/user/images/colorswatch/color-blue.png"></c:url>' alt="Blue"></a>
															</li>
															<li>
																<a data-image='<c:url value = "/assets/user/images/products/product-19-c2.jpg"></c:url>' href="#"><img src='<c:url value = "/assets/user/images/colorswatch/color-red.png"></c:url>' alt="Red"></a>
															</li>
															<li>
																<a data-image='<c:url value = "/assets/user/images/products/product-19-c3.jpg"></c:url>' href="#"><img src='<c:url value = "/assets/user/images/colorswatch/color-grey.png"></c:url>' alt="Grey"></a>
															</li>
															<li>
																<a data-image='<c:url value = "/assets/user/images/products/product-19-c4.jpg"></c:url>' href="#"><img src='<c:url value = "/assets/user/images/colorswatch/color-green.png"></c:url>' alt="Green"></a>
															</li>
															<li>
																<a data-image='<c:url value = "/assets/user/images/products/product-19-c5.jpg"></c:url>' href="#"><img src='<c:url value = "/assets/user/images/colorswatch/color-violet.png"></c:url>' alt="Violet"></a>
															</li>
														</ul>
													</div>
													<!-- /Product Photo -->
												...
												<div class="product-item-info">
													...
													<div class="product-item-photo">
														...
														<div class="product-item-gallery">
															<!-- product main photo -->
															<div class="product-item-gallery-main">
																<a href="#"><img class="product-image-photo" src='<c:url value = "/assets/user/images/products/product-13.jpg"></c:url>' alt=""></a>
																<a href="quick-view.html" title="Quick View" class="quick-view-link quick-view-btn"> <i class="icon icon-eye"></i><span>Quick View</span></a>
															</div>
															<!-- /product main photo  -->
														</div>
				...
				<div class="footer-top">
					<div class="container">
						...
						<div class="newsletter variant2 row">
							<div class="col-sm-3">
								<a href='<c:url value="/"></c:url>' title="Logo"><img src='<c:url value="/assets/user/images/logo-footer.png"></c:url>' alt class="img-responsive" /></a>
							</div>
							<div class="col-sm-9">
								<!-- input-group -->
								<form action="#">
