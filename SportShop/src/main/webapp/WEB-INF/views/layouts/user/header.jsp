	...
	<c:choose>
		<c:when test="${not empty currentCustomer}">
			...
			<div class="header-link dropdown-link header-account">
				<a
					href='<c:url value="/account/${currentCustomer.getId()}"></c:url>'>${currentCustomer.getFullName()}</a>
				<div class="dropdown-container right">
					<div class="title">Hello</div>
					<div class="top-text" style="color: green; font-size: 150%">${currentCustomer.getFullName()}</div>
					<button
						onclick="location.href='<c:url value="/account/${currentCustomer.getId()}"></c:url>'"
						class="btn btn-lg">View Account</button>
					<button
						onclick="location.href='<c:url value="/logoutHandelling"></c:url>'"
						class="btn btn-lg" data-toggle="modal" data-target="#logOutPopup">Logout</button>
				</div>
			</div>
		...
		<c:otherwise>
			<div class="header-link dropdown-link header-account">
				<a href='<c:url value="/login"></c:url>'> <i
					class="icon icon-user"></i>
				</a>
				<div class="dropdown-container right">
					<div class="title">Registered Customers</div>
					<div class="top-text">If you have an account with us, please
						log in.</div>

					<!-- form login  -->

					<c:url var="action_url" value="/loginHandelling" />
					<form:form method="post" class="account-create"
						action="${action_url }" modelAttribute="customer">
					...
					<div class="bottom-text">
						Create a <a href='<c:url value="/register"></c:url>'>New
							Account</a>
					</div>
				</div>
			</div>
	...
	<div class="exp-search">
		<form>
			<input class="exp-search-input " placeholder="Search here ..."
				...
				type="submit" value=""> <span class="exp-icon-search">
	...
	<div class="mobilemenu-content">
		<ul class="nav">
			<li><a href='<c:url value="/"></c:url>'">HOME</a> <span
				class="arrow"></span></li>
			<li><a href='<c:url value = "/all-product"></c:url>'>All
					Products</a></li>
			<li><a href='<c:url value = "/all-product"></c:url>'>Clothes</a>
			</li>
			<li><a href='<c:url value="/all-product"></c:url>'>Equipment</a>
			</li>
		</ul>
	</div>
</div>
...
<div class="megamenu fadein blackout">
	<ul class="nav">
		...
		<li class="mega-dropdown"><a
			href='<c:url value = "/all-product"></c:url>'> Clothes <span
				class="menu-label">-15%</span>
		</a>
			<div class="sub-menu">
				<div class="container">
					<div class="megamenu-categories column-4">
						...
						<div class="col">
							<a class="category-image" href="#"> <img
								src='<c:url value = "/assets/user/images/category/megamenu-category-03.jpg"></c:url>'
								alt />
							</a>
						...
						<div class="col">
							<a class="category-image" href="#"> <img
								src='<c:url value = "/assets/user/images/category/megamenu-category-04.jpg"></c:url>'
								alt />
							</a>
							<div class="category-title">
								<a href="#">Only Sale</a>
							...
							<ul class="category-links">
								...
								<li><a href="#"> <b>Sale Shoes</b> <span
										class="menu-label">THREE DAYS ONLY!</span>
								</a></li>
						...
						<div class="col">
							<a class="category-image" href="#"> <img
								src='<c:url value = "/assets/user/images/category/megamenu-category-05.jpg"></c:url>'
								alt />
							</a>
							<div class="category-title">
						...
						<div class="col">
							<a class="category-image" href="#"> <img
								src='<c:url value = "/assets/user/images/category/megamenu-category-06.jpg"></c:url>'
								alt />
							</a>
							<div class="category-title">
								<a href="#">Bottom</a>
		...
		<li class="mega-dropdown"><a
			href='<c:url value = "/all-product"></c:url>'> Equipments <span
				class="menu-label-alt">NEW</span>
		</a>
			<div class="sub-menu">
				<div class="container">
					<div class="megamenu-right width-25">
						<div class="banner style-1 autosize-text" data-fontratio="4.2">
							<img
								src='<c:url value = "/assets/user/images/banners/banner-1.jpg"></c:url>'
								alt="Banner">
					...
					<div class="megamenu-categories column-2">
						...
						<div class="col">
							<a class="category-image" href="#"> <img
								src='<c:url value = "/assets/user/images/category/megamenu-category-01.jpg"></c:url>'
								alt />
							</a>
							...
							<ul class="category-links column-count-2">
								...
								<li><a href="#"> Fascinators & Headpieces <span
										class="menu-label">HOT PRICE</span>
								</a></li>
						...
						<div class="col">
							<a class="category-image" href="#"> <img
								src='<c:url value = "/assets/user/images/category/megamenu-category-02.jpg"></c:url>'
								alt />
							</a>
							<div class="category-title title-border">
								<a href="#"> CLOTHING <span class="menu-label-alt">NEW</span>
								</a>
							</div>
							<ul class="category-links column-count-2">
								<li><a href="#">New In</a></li>
						...
						<div class="megamenu-bottom">
							<a href="#"> <img class="img-responsive"
								src='<c:url value = "/assets/user/images/banners/banner-megamenu.jpg"></c:url>'
								alt="megamenu banner">
							</a>
						</div>
						<!-- /megamenu bottom -->
