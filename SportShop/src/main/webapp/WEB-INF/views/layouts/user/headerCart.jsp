...
<div class="header-link dropdown-link header-cart variant-1">
	<a href='<c:url value="/cart"></c:url>'> <i class="icon icon-cart"></i>
		<span class="badge">${sessionScope.curCart.size() }</span>
	</a>
	<!-- minicart wrapper -->
											...
											<div class="product-item-details">
												...
												<div class="product-item-qty">
													<label class="label">Qty</label> <input
														class="item-qty cart-item-qty" maxlength="12" value="${item.getQuantity() }">
												...
												<div class="product-item-pricing">
													<div class="price-container">
														<span class="price-wrapper"> <span
															class="price-excluding-tax"> <span
																class="minicart-price"> <span class="price">$<fmt:formatNumber type="number" value ="${item.getPrice()}"/></span>
															</span>
														</span>
														</span>
													</div>
													<div class="product actions">
														...
														<div class="primary">
															<a class="action edit" href="#" title="Edit item"> <span>Edit</span>
															</a>
														</div>
													</div>
												</div>
